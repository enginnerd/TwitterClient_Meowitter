    ...
    private void populateTimeline_real(boolean dontClear){
        ...
        client.getMentionsTimeline(new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray json) {
                ...
                Tweet.fromJSONArray(json, Tweet.MENTIONS, /*TwitterApp.g_user.getScreenName()*/"khiemkardashian"); //add to DB
//                Log.i("DEBUG-MENTIONS", "G_USER: " + TwitterApp.g_user.getScreenName());
                last_id =getTweets(f_dontClear, last_id, Tweet.MENTIONS, /*TwitterApp.g_user.getScreenName()*/"khiemkardashian");
...
//                        getTweets(f_dontClear);
                ...
                getTweets(f_dontClear, last_id, Tweet.MENTIONS, TwitterApp.g_user.getScreenName());
